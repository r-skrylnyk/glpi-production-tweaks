...
***REMOVED*** If the production crypto key is provided, restore it.
***REMOVED*** This is required to decrypt encrypted fields from an existing database.
***REMOVED*** Set the GLPI_CRYPT_KEY secret to the contents of your production glpicrypt.key file.
